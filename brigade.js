...
events.on("push", (brigadeEvent, project) => {
    ...
    brigConfig.set("apiImage", "/smackapi")
...
function helmJobRunner (config, h, prodWeight, canaryWeight, deployType) {
    ...
    h.tasks = [
        ...
        `helm upgrade --install smackweb-${deployType} ./smackweb --namespace microsmack --set api.image=${config.get("apiACRImage")} --set api.imageTag=${config.get("imageTag")} --set api.deployment=smackapi-${deployType} --set api.versionLabel=${deployType}`,
